        ...
        (
            ...
            cirq.Circuit((cirq.X**sympy.Symbol('x0_0')).on(cirq.GridQubit(0, 0)),
                        (cirq.X**sympy.Symbol('x0_1')).on(cirq.GridQubit(0, 1)),
                         (cirq.X**sympy.Symbol('x0_2')).on(cirq.GridQubit(0, 2)),
                        (cirq.X**sympy.Symbol('x0_3')).on(cirq.GridQubit(0, 3)),
                        (cirq.Z**sympy.Symbol('z0_0')).on(cirq.GridQubit(0, 0)),
                        (cirq.Z**sympy.Symbol('z0_1')).on(cirq.GridQubit(0, 1)),
                        (cirq.Z**sympy.Symbol('z0_2')).on(cirq.GridQubit(0, 2)),
                        (cirq.Z**sympy.Symbol('z0_3')).on(cirq.GridQubit(0, 3))),
        ),
        (
            [1, 2], 
            [1, 1], 
            ...
            cirq.Circuit((cirq.X**sympy.Symbol('x0_0')).on(cirq.GridQubit(0, 0)),
                        ...
                        (cirq.X**sympy.Symbol('x1_2')).on(cirq.GridQubit(0, 2)),
                        (cirq.X**sympy.Symbol('x1_3')).on(cirq.GridQubit(0, 3)),
                        (cirq.Z**sympy.Symbol('z1_0')).on(cirq.GridQubit(0, 0)),
                        (cirq.Z**sympy.Symbol('z1_1')).on(cirq.GridQubit(0, 1)),
                        (cirq.Z**sympy.Symbol('z1_2')).on(cirq.GridQubit(0, 2)),
                        (cirq.Z**sympy.Symbol('z1_3')).on(cirq.GridQubit(0, 3))),
        )
    ]
)
    ...
    [
        (
            ...
            cirq.Circuit(cirq.PhasedXPowGate(exponent=sympy.Symbol('x0'), phase_exponent=sympy.Symbol('z0')).on(cirq.GridQubit(0, 0)),
                        ...
                        cirq.PhasedXPowGate(exponent=sympy.Symbol('x0'), phase_exponent=sympy.Symbol('z0')).on(cirq.GridQubit(0, 3)),
                        cirq.PhasedXPowGate(exponent=sympy.Symbol('x0'), phase_exponent=sympy.Symbol('z0')).on(cirq.GridQubit(0, 4)),
                        cirq.PhasedXPowGate(exponent=sympy.Symbol('x0'), phase_exponent=sympy.Symbol('z0')).on(cirq.GridQubit(0, 5)),
                        cirq.PhasedXPowGate(exponent=sympy.Symbol('y0'), phase_exponent=sympy.Symbol('w0')).on(cirq.GridQubit(0, 0)),
                        cirq.PhasedXPowGate(exponent=sympy.Symbol('y0'), phase_exponent=sympy.Symbol('w0')).on(cirq.GridQubit(0, 1)),
                        cirq.PhasedXPowGate(exponent=sympy.Symbol('y0'), phase_exponent=sympy.Symbol('w0')).on(cirq.GridQubit(0, 2)),
                        cirq.PhasedXPowGate(exponent=sympy.Symbol('y0'), phase_exponent=sympy.Symbol('w0')).on(cirq.GridQubit(0, 3)),
                        cirq.PhasedXPowGate(exponent=sympy.Symbol('y0'), phase_exponent=sympy.Symbol('w0')).on(cirq.GridQubit(0, 4)),
                        cirq.PhasedXPowGate(exponent=sympy.Symbol('y0'), phase_exponent=sympy.Symbol('w0')).on(cirq.GridQubit(0, 5)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 1)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 2)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 3)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 4)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 5)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 1), cirq.GridQubit(0, 2)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 1), cirq.GridQubit(0, 3)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 1), cirq.GridQubit(0, 4)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 1), cirq.GridQubit(0, 5)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 3)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 4)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 5)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 3), cirq.GridQubit(0, 4)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 3), cirq.GridQubit(0, 5)),
                        cirq.ZZPowGate(exponent=sympy.Symbol('theta0')).on(cirq.GridQubit(0, 4), cirq.GridQubit(0, 5)),
                        
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 1)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 2)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 3)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 4)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 5)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 1), cirq.GridQubit(0, 2)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 1), cirq.GridQubit(0, 3)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 1), cirq.GridQubit(0, 4)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 1), cirq.GridQubit(0, 5)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 3)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 4)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 5)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 3), cirq.GridQubit(0, 4)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 3), cirq.GridQubit(0, 5)),
                        cirq.XXPowGate(exponent=sympy.Symbol('mu0')).on(cirq.GridQubit(0, 4), cirq.GridQubit(0, 5)),
                )
        )
    ]
)
