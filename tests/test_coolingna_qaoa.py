...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            cirq.Circuit(cirq.H.on(cirq.GridQubit(0, 0)), cirq.H.on(cirq.GridQubit(0, 1)), cirq.H.on(cirq.GridQubit(0, 2)), cirq.H.on(cirq.GridQubit(0, 3)), 
                        ...
                        (cirq.X**sympy.Symbol('b0')).on(cirq.GridQubit(0, 3)),
                        ...
                        (cirq.XX**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 3)),
                        (cirq.X**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 0)),
                        (cirq.Z**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 1)),
                        (cirq.X**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 2)),
                        (cirq.Z**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 3))),
        ),
        (
            [1, 3], 
            [1, 1], 
            ...
            {"2QubitGates" : [lambda q1, q2, theta: cirq.ZZ(q1, q2)**(theta),
                              lambda q1, q2, theta: cirq.ZZ(q1, q2)**(theta),
                             lambda q1, q2, theta: cirq.XX(q1, q2)**(theta)]},
            cirq.Circuit(cirq.H.on(cirq.GridQubit(0, 0)), cirq.H.on(cirq.GridQubit(0, 1)), cirq.H.on(cirq.GridQubit(0, 2)),cirq.H.on(cirq.GridQubit(0, 3)), cirq.H.on(cirq.GridQubit(0, 4)), cirq.H.on(cirq.GridQubit(0, 5)), 
                        (cirq.X**sympy.Symbol('b0')).on(cirq.GridQubit(0, 0)),
                        (cirq.X**sympy.Symbol('b0')).on(cirq.GridQubit(0, 1)),
                        (cirq.X**sympy.Symbol('b0')).on(cirq.GridQubit(0, 2)),
                        (cirq.X**sympy.Symbol('b0')).on(cirq.GridQubit(0, 3)),
                        (cirq.X**sympy.Symbol('b0')).on(cirq.GridQubit(0, 4)),
                        (cirq.X**sympy.Symbol('b0')).on(cirq.GridQubit(0, 5)),
                        (cirq.ZZ**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 2)),
                        (cirq.ZZ**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 4)),
                        (cirq.XX**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 1)),
                        (cirq.XX**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 3)),
                        (cirq.XX**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 4), cirq.GridQubit(0, 5)),
                        (cirq.Z**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 0)),
                        (cirq.Z**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 1)),
                        (cirq.Z**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 2)),
                        (cirq.Z**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 3)),
                        (cirq.Z**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 4)),
                        (cirq.Z**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 5))),
        ),
        (
            [1, 3], 
            [1, 0], 
            ...
            cirq.Circuit(cirq.H.on(cirq.GridQubit(0, 0)), cirq.H.on(cirq.GridQubit(0, 1)), cirq.H.on(cirq.GridQubit(0, 2)),cirq.H.on(cirq.GridQubit(0, 3)), cirq.H.on(cirq.GridQubit(0, 4)), cirq.H.on(cirq.GridQubit(0, 5)), 
                        ...
                        (cirq.X**sympy.Symbol('b0')).on(cirq.GridQubit(0, 5)),
                        (cirq.ZZ**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 2)),
                        (cirq.ZZ**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 4), cirq.GridQubit(0, 0)),
                        (cirq.ZZ**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 4)),
                        (cirq.XX**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 1)),
                        (cirq.XX**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 3)),
                        (cirq.XX**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 4), cirq.GridQubit(0, 5)),
        ...
        (
            ...
            cirq.Circuit(cirq.H.on(cirq.GridQubit(0, 0)), cirq.H.on(cirq.GridQubit(0, 1)), cirq.H.on(cirq.GridQubit(0, 2)),cirq.H.on(cirq.GridQubit(0, 3)), cirq.H.on(cirq.GridQubit(0, 4)), cirq.H.on(cirq.GridQubit(0, 5)), 
                        ...
                        (cirq.X**sympy.Symbol('b1')).on(cirq.GridQubit(0, 3)),
                        (cirq.X**sympy.Symbol('b1')).on(cirq.GridQubit(0, 4)),
                        (cirq.X**sympy.Symbol('b1')).on(cirq.GridQubit(0, 5)),
                        (cirq.ZZ**(1.0*sympy.Symbol('g1'))).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 2)),
                        (cirq.ZZ**(1.0*sympy.Symbol('g1'))).on(cirq.GridQubit(0, 4), cirq.GridQubit(0, 0)),
                        (cirq.ZZ**(1.0*sympy.Symbol('g1'))).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 4)),
                        (cirq.XX**(1.0*sympy.Symbol('g1'))).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 1)),
                        (cirq.XX**(1.0*sympy.Symbol('g1'))).on(cirq.GridQubit(0, 2), cirq.GridQubit(0, 3)),
                        (cirq.XX**(1.0*sympy.Symbol('g1'))).on(cirq.GridQubit(0, 4), cirq.GridQubit(0, 5)),
                        ...
                        (cirq.Z**(1.0*sympy.Symbol('g1'))).on(cirq.GridQubit(0, 3)),
                        (cirq.Z**(1.0*sympy.Symbol('g1'))).on(cirq.GridQubit(0, 4)),
                        (cirq.Z**(1.0*sympy.Symbol('g1'))).on(cirq.GridQubit(0, 5))),
        ),
        (
            [3, 1], 
            [0, 1], 
            ...
            {"1QubitGates": [lambda q, theta: cirq.Z(q)**(theta),
             ...
             "2QubitGates": [lambda q1, q2, theta: cirq.ZZ(q1, q2)**(theta),
                              lambda q1, q2, theta: cirq.ZZ(q1, q2)**(theta),
                             lambda q1, q2, theta: cirq.XX(q1, q2)**(theta)]},
            cirq.Circuit(cirq.H.on(cirq.GridQubit(0, 0)), cirq.H.on(cirq.GridQubit(1, 0)), cirq.H.on(cirq.GridQubit(2, 0)),cirq.H.on(cirq.GridQubit(0, 1)), cirq.H.on(cirq.GridQubit(1, 1)), cirq.H.on(cirq.GridQubit(2, 1)), 
                        (cirq.X**sympy.Symbol('b0')).on(cirq.GridQubit(0, 0)),
                        ...
                        (cirq.XX**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 0), cirq.GridQubit(0, 1)),
                        (cirq.XX**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(1, 0), cirq.GridQubit(1, 1)),
                        (cirq.XX**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(2, 0), cirq.GridQubit(2, 1)),
                        (cirq.Z**(1.0*sympy.Symbol('g0'))).on(cirq.GridQubit(0, 0)),
